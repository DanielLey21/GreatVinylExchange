...
members = ["Jake Heninger","Nate Ley", "Matt Bata","Adam Hernandez","Adam Malcore","DJ Ley","Perry Krum"]
# Members who can send a vinyl
sendList = ["Jake Heninger","Adam Hernandez", "Matt Bata","Adam Hernandez","Adam Malcore","DJ Ley","Perry Krum"]
...
while(len(sendList) != 0):
    ...
    while(not notSamePerson):
        ...
        if(sender != reciever):
            ...
            sendList = ["Jake Heninger","Nate Ley", "Matt Bata","Adam Hernandez","Adam Malcore","DJ Ley","Perry Krum"]
            recList = ["Jake Heninger","Nate Ley", "Matt Bata","Adam Hernandez","Adam Malcore","DJ Ley","Perry Krum"]
            matchUps = []
    monthCount = 0
